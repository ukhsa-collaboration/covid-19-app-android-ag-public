...
class RiskyVenueCircuitBreakerConfigurationProviderTest {
    ...
    companion object {
        ...
        private val SINGLE_POLLING_CONFIGURATION_JSON =
            """
            [{"startedAt":"2020-07-27T01:00:00Z","venueId":"venue1","approvalToken":"token1","isPolling":true}]
            """.trim()

        private val MULTIPLE_POLLING_CONFIGURATION_JSON =
            """
            [{"startedAt":"2020-07-27T01:00:00Z","venueId":"venue1","approvalToken":"token1","isPolling":true},{"startedAt":"2020-07-28T01:00:00Z","venueId":"venue2","approvalToken":"token2","isPolling":true}]
            """.trim()
    }
}
