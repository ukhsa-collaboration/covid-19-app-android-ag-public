...
class LastVisitedBookTestTypeVenueDateProviderTest : ProviderTest<LastVisitedBookTestTypeVenueDateProvider, LastVisitedBookTestTypeVenueDate?>() {
    ...
    override val getTestSubject: (Moshi, SharedPreferences) -> LastVisitedBookTestTypeVenueDateProvider =
        { moshi, sharedPreferences -> LastVisitedBookTestTypeVenueDateProvider(fixedClock, moshi, sharedPreferences) }
